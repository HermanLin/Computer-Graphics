...
def add_cylinder( polygons, cx, cy, cz, r, h, step ):
    ...
    while i <= step:
        ...
        add_polygon(polygons, cx, cy + h, cz, x, cy + h, z, x1, cy + h, z1)
        add_polygon(polygons, x, cy, z, x1, cy, z1, x1, cy + h, z1)
        add_polygon(polygons, x, cy, z, x1, cy + h, z1, x, cy + h, z)
        x = x1
        z = z1        
        i += 1

def add_pyramid( polygons, x, y, z, h, w ):
    x1 = x + w
    y1 = y - h
    z1 = z - w
    x2 = x + w/2
